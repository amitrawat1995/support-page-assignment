      ...
      <div className='bg-white h-24 px-10 flex items-center justify-between relative ' >
        ...
        <div className='flex items-center gap-12'>
          <div className='hidden lg:flex'>
            <a href="" className='flex items-center gap-2'>
              <p className='text-lg hover:text-red-400' style={{fontFamily:"lexend"}}>Go to Tilda.cc</p>
          ...
          <div className='hidden lg:flex'>
          <a href="" className='flex items-center gap-2'>
              <p className='text-lg hover:text-red-400' style={{fontFamily:"lexend"}}>Go to Help Center</p>
              <FontAwesomeIcon icon={faArrowUpRightFromSquare} className='text-xs opacity-1'/>
          </a>
          </div> 
          ...
          <button  className='border-2 border-gray-300 hover:border-gray-400 rounded-md flex items-top gap-1 py-2 px-4'>
            ...
            <button className='lg:hidden text-2xl border-2  border-gray-300 hover:border-gray-400 rounded p-2 px-3' onClick={toggleSidebar} ><FontAwesomeIcon  icon={faBars} /></button>
        ...
        <div className={`lg-hidden fixed top-0 z-50 right-0 h-screen bg-white w-64 shadow-lg transform transition-transform ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <button onClick={toggleSidebar} className='border-2 m-4 mx-4'>
            <FontAwesomeIcon className='p-2 text-3xl right hover:text-blue-500' icon={faXmark} />
          </button> 
          <hr className='m-3'/>       
          <a href="" className='flex items-center p-4 gap-2'>
            <p className='text-lg hover:text-red-400'>Go to Tilda.cc</p>
            <FontAwesomeIcon icon={faArrowUpRightFromSquare} className='text-xs opacity-1' />
          </a>
          <a href="" className='flex items-center p-4 gap-2'>
            <p className='text-lg hover:text-red-400'>Go to Help Center</p>
            <FontAwesomeIcon icon={faArrowUpRightFromSquare} className='text-xs opacity-1' />
          </a>
        </div>
